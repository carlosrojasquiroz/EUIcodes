...
%---------------------------------------------------------------------------------------------------------------------------
p.naa=200; % # of assets grid points
...
load ss0.mat Ks; % results from Aiyagari without aggregate shocks
...
p.init0=1000; % initial period for computing the DenHaan's test
p.end0=1100; % final period for computing the DenHaan's test
